...
const ITEMS = [
  {
    id: "Instagram", label: "Instagram", handle: "@yourname", href: "https://www.instagram.com/laisontrading", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
    links: ["https://www.instagram.com/laisontrading"],
    stats: [
      { tag: "FOL", value: "30", color: "#9147ff" }
    ],
  }
  // {
  //   id: "instagram", label: "INSTAGRAM", handle: "@yourhandle", href: "https://www.instagram.com/laisontrading?igsh=MXQzODE5djZpdHY2YQ==", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
