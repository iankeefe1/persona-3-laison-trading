...
const ITEMS = [
  {
    id: "Tokopedia", label: "Tokopedia", handle: "@yourname", href: "https://www.tokopedia.com/laisontrading", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
    links: ["https://www.tokopedia.com/laisontrading"],
    stats: [
    ],
  },
  {
    id: "Shopee", label: "Shopee", handle: "@yourhandle", href: "https://www.instagram.com/laisontrading?igsh=MXQzODE5djZpdHY2YQ==", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
    links: ["https://shopee.co.id/laisontrading", "instagram.com/p/C3wLpBsOj7f", "instagram.com/reel/C2vKoArMi6e", "instagram.com/p/C1uJnZqLh5d", "instagram.com/reel/C0tImYpKg4c"],
    stats: [
    ],
  },
  {
